...
def new(project_name):
    ...
    """
    # Logic to generate new project structure
...
def test(modules):
    ...
    if not modules:
        ...
        module_test_paths = [f"modules/{module_name}/tests" for module_name in modules]
...
def run():
    ...
    if not os.path.exists('app.py') or not os.path.isdir('modules'):
        click.echo("This doesn't seem to be a valid 'constrictor' project. Ensure you're in the project root and 'app.py' exists.")
        return
